...
class RestaurantTableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        //Configure SeerchController
        // Adding a search bar
        searchController = UISearchController(searchResultsController: nil)
        searchController.searchResultsUpdater = self
        searchController.obscuresBackgroundDuringPresentation = false
        searchController.searchBar.placeholder = "Пошук Ресторану"
    ...
    // MARK: - UITableViewDelegate Protocol
     ...
     func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let deleteAction = UIContextualAction(style: .destructive, title: "Видалити") { (action, sourceView, completionHandler) in
        ...
        let shareAction = UIContextualAction(style: .normal, title: "Поділитися") { (action, sourceView, completionHandler) in
