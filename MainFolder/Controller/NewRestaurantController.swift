...
class NewRestaurantController: UITableViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row == 0 {
            ...
            let photoSourceRequestController = UIAlertController(title: "Фото", message: "Вибери фотку", preferredStyle: .actionSheet)
            ...
            let photoLibraryAction = UIAlertAction(title: "Фотоплівка", style: .default, handler: { (action) in
    ...
    @IBAction func saveButtonTapped(sender: AnyObject) {
        ...
        print("Назва: \(nameTextField.text ?? "")")
        print("Тип: \(typeTextField.text ?? "")")
        print("Розташування: \(addressTextField.text ?? "")")
        print("Телефон: \(phoneTextField.text ?? "")")
        print("Опис: \(descriptionTextView.text ?? "")")
        ...
        if let appDelegate = (UIApplication.shared.delegate as? AppDelegate) {
            ...
            print("Зберігання КорДати і вона таки працює!!!")
